...
def mapillary_v1_classes():
    ...
    return [
        'Bird', 'Ground Animal', 'Curb', 'Fence', 'Guard yolo_head-Rail', 'Barrier',
        'Wall', 'Bike Lane', 'Crosswalk - Plain', 'Curb Cut', 'Parking',
        'Pedestrian Area', 'yolo_head-Rail Track', 'Road', 'Service Lane', 'Sidewalk',
...
def mapillary_v2_classes():
    ...
    return [
        ...
        'Fence', 'Guard yolo_head-Rail', 'Barrier', 'Road Median', 'Road Side',
        'Lane Separator', 'Temporary Barrier', 'Wall', 'Bike Lane',
        'Crosswalk - Plain', 'Curb Cut', 'Driveway', 'Parking',
        'Parking Aisle', 'Pedestrian Area', 'yolo_head-Rail Track', 'Road',
