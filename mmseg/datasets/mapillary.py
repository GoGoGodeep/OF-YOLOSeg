...
class MapillaryDataset_v1(BaseSegDataset):
    ...
    """
    METAINFO = dict(
        classes=('Bird', 'Ground Animal', 'Curb', 'Fence', 'Guard yolo_head-Rail',
                 'Barrier', 'Wall', 'Bike Lane', 'Crosswalk - Plain',
                 'Curb Cut', 'Parking', 'Pedestrian Area', 'yolo_head-Rail Track',
...
class MapillaryDataset_v2(BaseSegDataset):
    ...
    METAINFO = dict(
        classes=(
            ...
            'Curb', 'Fence', 'Guard yolo_head-Rail', 'Barrier', 'Road Median',
            'Road Side', 'Lane Separator', 'Temporary Barrier', 'Wall',
            'Bike Lane', 'Crosswalk - Plain', 'Curb Cut', 'Driveway',
            'Parking', 'Parking Aisle', 'Pedestrian Area', 'yolo_head-Rail Track',
